<?php
if (!isset($biggestOrders)) {
    $biggestOrders = [];
    $biggestOrder = new Order();
    $biggestOrders[] = $biggestOrder;
}
if (!isset($mostConnectedUsers)) {
    $mostConnectedUsers = [];
    $mostConnectedUser = new User();
    $mostConnectedUsers[] = $mostConnectedUser;
}
if (!isset($topChiefs)) {
    $topChiefs = [];
    $topChief = new User();
...
if (!isset($articleOutOfStock)) {
    $articleOutOfStock = [];
    $article = new Article();
    $articleOutOfStock[] = $article;
}
if (!isset($totalPurchasedPerDay)) {
    $totalPurchasedPerDay = [];
}
if (!isset($totalSoldPerDay)) {
    $totalSoldPerDay = [];
}
if (!isset($connectionPerHour)) {
    $connectionPerHour = [];
}
if (!isset($articleSold)) {
    $articleSold = [];
}
if (!isset($articleBought)) {
    $articleBought = [];
}
if (!isset($articleInStock)) {
    $articleInStock = [];
}
?>
