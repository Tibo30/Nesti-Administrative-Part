    ...
    <div class="d-flex flex-row justify-content-between">
        <nav class="navbar navbar-white bg-white pl-0">
            <form class="form-inline">
                ...
                <img id="searchUser" src="<?php BASE_URL ?>public/pictures/search-svg.svg" alt="">
            </form>
        </nav>
        <div>
            <a id="btnAddUser" href="user/add" class="btn mb-1 border align-self-end"> <img id="addUser" src="<?php BASE_URL ?>public/pictures/create-svg.svg" alt="svg plus">
                Add User</a>
        </div>
